...
| 2026-09-08 | `naming-rules` | añadido | Nomenclatura literal e intraducible, marca pública (`SLG Agency` vs "Softlanding Global" en contexto `Holdings by SLG`), regla dura de la "D" de DAL OS, tono y notación de origen. Fuente: §1 Constraints, A.1, gate D5 |
...
| 2026-09-08 | `offer-structure` | añadido | Las dos ramas, las tres líneas de `VoltAi by SLG`, las 11 páginas con documento `D-01`…`D-11` y el contrato de seis secciones de la página de servicio. Fuente: §1, A.1, A.2, A.3, A.4, D-17 |
