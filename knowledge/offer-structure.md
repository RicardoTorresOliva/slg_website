...
description: Las dos ramas (VoltAi by SLG y Holdings by SLG), las tres líneas de VoltAi by SLG y las páginas de servicio con su documento de descarga. Es la fuente de la navegación, del mapa de rutas y de la nomenclatura.
...
|---|---|---|---|
| `VoltAi by SLG` | `/ai` | `/en/ai` | La rama de servicios de IA. Se despliega en tres líneas. |
| `Holdings by SLG` | `/holdings` | `/en/holdings` | La otra rama. Único contexto en el que la marca pública se escribe "Softlanding Global". Tiene **tres líneas**: `[PENDIENTE: los nombres de las tres líneas de Holdings by SLG — A.3-3 las exige listar "tal cual la fuente", pero el brief no las enumera]` |
...
## 2. Las tres líneas de `VoltAi by SLG`

| Línea | Ruta ES | Ruta EN | Contiene |
|---|---|---|---|
| `VoltAi Academy` | `/ai/academy` | `/en/ai/academy` | 5 servicios (formación y acompañamiento de directivos) |
| `VoltAi Enterprise` | `/ai/enterprise` | `/en/ai/enterprise` | 2 servicios (diagnóstico e implementación) |
| `VoltAi Factory` | `/ai/factory` | `/en/ai/factory` | 3 servicios (construcción de activos) |
...
|---|---|---|---|---|
| D-01 | `Phoenix PEEx` | `VoltAi Academy` | `/ai/academy/phoenix-peex` | `/en/ai/academy/phoenix-peex` |
| D-02 | `Phoenix TEAx` | `VoltAi Academy` | `/ai/academy/phoenix-teax` | `/en/ai/academy/phoenix-teax` |
| D-03 | `Phoenix RETx` | `VoltAi Academy` | `/ai/academy/phoenix-retx` | `/en/ai/academy/phoenix-retx` |
| D-04 | Customize Programs | `VoltAi Academy` | `/ai/academy/customize-programs` | `/en/ai/academy/customize-programs` |
| D-05 | AI Coaching for Directors | `VoltAi Academy` | `/ai/academy/ai-coaching` | `/en/ai/academy/ai-coaching` |
| D-06 | `SLG_Readiness` | `VoltAi Enterprise` | `/ai/enterprise/readiness` | `/en/ai/enterprise/readiness` |
| D-07 | `SLG_Implement` | `VoltAi Enterprise` | `/ai/enterprise/implement` | `/en/ai/enterprise/implement` |
| D-08 | `APP_Building` | `VoltAi Factory` | `/ai/factory/app-building` | `/en/ai/factory/app-building` |
| D-09 | `AGE_Building` | `VoltAi Factory` | `/ai/factory/age-building` | `/en/ai/factory/age-building` |
| D-10 | `CoO as a Service` | `VoltAi Factory` | `/ai/factory/coo-as-a-service` | `/en/ai/factory/coo-as-a-service` |
| D-11 | `Holdings by SLG` | — (rama) | `/holdings` | `/en/holdings` |
...
las tres líneas de `VoltAi by SLG`** y la undécima es la rama `Holdings by SLG`. `D-17` resolvió la
...
La navegación principal expone **exactamente cinco destinos** (`VoltAi by SLG`, `Holdings by SLG`, Doctrina,
...
3. **Qué incluye** — la lista tal cual la fuente (p. ej. las 11 dimensiones de `SLG_Readiness`, las
   tres promesas de `CoO as a Service`, las tres líneas de `Holdings by SLG`).
...
- **`Phoenix Academy` (academy.softlandingglobal.com) está fuera de alcance**: solo enlace desde
  `VoltAi Academy` mientras siga vivo (§10-7).
