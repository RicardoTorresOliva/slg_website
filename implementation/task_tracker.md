...
**Estado global:** 35 `pending` · **1 `in_progress`** (FU-05, mitad de agente hecha) · 0 `blocked` · 0 `review` · **3 `done`** (FU-02, FU-03, FU-04 · 2026-09-08). **M0-A completo salvo FU-05**, ya desbloqueada (EXT-7 cerrada por D-49; S-01 diferida a go-live). Antes decía que esperaba a S-01 y a EXT-7.
