> **Este archivo era el `README.md` del template APP_Builder v4.1.** Se movió aquí en DU-24: la
> raíz de un repositorio de proyecto tiene que abrirse con el manual del proyecto, no con el de la
> fábrica que lo produjo. Sigue siendo válido y describe la maquinaria con la que se construye
> `slg_website`; quien venga a **construir** lo necesita, y `AGENTS.md` sigue siendo la
> gobernanza.
